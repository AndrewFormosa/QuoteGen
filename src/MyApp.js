  ...
  render() {
    ...
    return (
      <div id="quote-box" class="card shadow fade-out">
        ...
        <a class="twitter-share-button d-flex justify-content-center" id="tweet-quote" href={twitterHref} data-size="large">Share ths quote..<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-twitter" viewBox="0 0 16 16">
...
render(){
  return(
    ...
    <h1><svg xmlns="http://www.w3.org/2000/svg" width='6vw' height="6vw" fill="currentColor" class="bi bi-emoji-smile" viewBox="0 0 16 16">
...
changeBackground(){return
    $(document.body.style.background=variables.bgColor);
  }
